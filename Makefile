# This Makefile is for the Class::DBI::Loader::DB2 extension to perl.
#
...
#	ABSTRACT_FROM => q[lib/Class/DBI/Loader/DB2.pm]
#	AUTHOR => q[Mark Ferris <mark.ferris@geac.com>]
#	NAME => q[Class::DBI::Loader::DB2]
#	PREREQ_PM => { Class::DBI::DB2=>q[0.14], DBD::DB2=>q[0], Class::DBI::Loader=>q[0.02], Test::More=>q[0.47] }
#	VERSION_FROM => q[lib/Class/DBI/Loader/DB2.pm]
...
DISTNAME = Class-DBI-Loader-DB2
NAME_SYM = Class_DBI_Loader_DB2
VERSION = 0.11
VERSION_SYM = 0_11
XS_VERSION = 0.11
INST_BIN = blib/bin
...
FULLEXT = Class/DBI/Loader/DB2
BASEEXT = DB2
PARENT_NAME = Class::DBI::Loader
DLBASE = $(BASEEXT)
...
HTMLSCRIPTPODS = 
MAN1PODS = 
MAN3PODS = lib/Class/DBI/Loader/DB2.pm
HTMLEXT = html
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Class/DBI/Loader
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Class/DBI/Loader
...
TO_INST_PM = lib/Class/DBI/Loader/DB2.pm

PM_TO_BLIB = lib/Class/DBI/Loader/DB2.pm \
	$(INST_LIB)/Class/DBI/Loader/DB2.pm
...
manifypods : pure_all lib/Class/DBI/Loader/DB2.pm
	@$(POD2MAN) \
	lib/Class/DBI/Loader/DB2.pm \
	$(INST_MAN3DIR)/Class::DBI::Loader::DB2.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f  $(INST_LIB)/Class/DBI/Loader/DB2.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Class-DBI-Loader-DB2\" VERSION=\"0,11,0,0\">\n}. qq{\t<TITLE>Class-DBI-Loader-DB2</TITLE>\n}. qq{\t<ABSTRACT>Class::DBI::Loader DB2 implementation.</ABSTRACT>\n}. qq{\t<AUTHOR>Mark Ferris &lt;mark.ferris\@geac.com&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"Class-DBI-DB2\" VERSION=\"0,14,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Class-DBI-Loader\" VERSION=\"0,02,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"DBD-DB2\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Test-More\" VERSION=\"0,47,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"sun4-solaris\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Class-DBI-Loader-DB2.ppd
